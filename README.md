...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/cloudflare-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11104&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/cloudflare-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `cloudflare` can be installed with:

```
conda install cloudflare
```

It is possible to list all of the versions of `cloudflare` available on your platform with:
